 ...
 *  LGW-DME 2014-7-18
	...
	FCO-BEG 2014-7-22
 */
public class Wrapper_gjdairil001 implements QunarCrawler {
	...
	public static void main(String[] args) {
		...
		String html = "";
		html = new Wrapper_gjdairil001().getHtml(searchParam);
//		try {
...
//		 }
		 ...
		 result = new Wrapper_gjdairil001().process(html,searchParam);
		 if(result.isRet() && result.getStatus().equals(Constants.SUCCESS))
		 {
		 List<OneWayFlightInfo> flightList = (List<OneWayFlightInfo>)
		 result.getData();
	...
	public String getHtml(FlightSearchParam param) {
		...
		String endDate=getDaysAfter(param.getDepDate(),7);
		try {
			...
			NameValuePair[] pairs = new NameValuePair[] {
					...
					new NameValuePair("fromCity", param.getDep()),
					//"201407"
					...
					new NameValuePair("toCity", param.getArr()),
					//201407
					new NameValuePair("endTimeMon", getDateFormart(endDate,"yyyyMM")),
					//30
					new NameValuePair("endTimeDay", getDateFormart(endDate,"dd")),
					//2014-07-30
					new NameValuePair("endTimeCal", endDate),
